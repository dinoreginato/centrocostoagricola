...
async function test() {
  ...
  console.log("Order 8 data:", JSON.stringify(order, null, 2));
  ...
  console.log("Items to insert:", itemsData);
  console.log("Total Cost:", totalCost);
  
  // Test 1: Insert into Applications
  const appInsert = {
  ...
  for (const itemData of itemsData) {
      const itemInsert = {
          ...
          // objective: itemData.objective // REMOVED BECAUSE WE FOUND IT DIDNT EXIST
      };
