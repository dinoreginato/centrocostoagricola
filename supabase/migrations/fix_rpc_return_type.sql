-- Fix RPC return type mismatch by ensuring explicit casting
-- The error "structure of query does not match function result type" means the columns returned
-- don't match the RETURNS TABLE definition exactly in types or order.
