    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
            ...
            <p className="text-sm text-gray-500">Asigna costos de riego y electricidad a sectores</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-1 bg-white rounded-lg shadow overflow-hidden">
            ...
            <div className="divide-y divide-gray-200 max-h-[600px] overflow-y-auto">
                {pendingItems.length === 0 ? (
                    <div className="p-8 text-center text-gray-500 text-sm">No hay items de riego pendientes.</div>
                ) : (
                    ...
                    {!editingAssignmentId && (
                        <div className="flex space-x-4 mb-6">
                            <button
                                ...
                                className={`flex-1 py-2 px-4 rounded-l-md text-sm font-medium border ${distributeBy === 'sector' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'bg-white border-gray-300 text-gray-700'}`}
                            >
                                Por Sector Específico
                            </button>
                            <button
                                onClick={() => setDistributeBy('field')}
                                className={`flex-1 py-2 px-4 border text-sm font-medium border ${distributeBy === 'field' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'bg-white border-gray-300 text-gray-700'}`}
                            >
                            ...
                            <button
                                ...
                                className={`flex-1 py-2 px-4 rounded-r-md text-sm font-medium border ${distributeBy === 'company' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'bg-white border-gray-300 text-gray-700'}`}
                            >
                                Empresa General
                            </button>
                        </div>
